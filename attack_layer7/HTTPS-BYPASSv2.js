...
if(!args[0]) {
	...
	.setColor('RANDOM')
	.setTitle('WARRING')
	.setDescription("`Ex ;HTTPS-BYPASSv2 https://example.com/ 60`")
...
exec(`node HTTPS-BYPASSv2.js ${host} ${duration}`, (error, stdout, stderr) => {
});
